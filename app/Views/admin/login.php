                        ...
                        <div class="card-body">
                           ...
                           <label class="input-label">Email Address</label><br>
                              <div class="input-group mb-3">
                                 ...
                                 <input type="text" class="form-control" id="frmUser" placeholder="e.g. sample@gmail.com" name="email" aria-label="email" value="<?= set_value('email') ?>" aria-describedby="basic-addon1">
                              </div>
